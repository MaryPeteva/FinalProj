...
namespace OnlyTools.Infrastructure.Migrations
{
    ...
    [Migration("20240423164944_jobListingsCategoriesAded")]
    partial class jobListingsCategoriesAded
    {
            ...
            modelBuilder.Entity("OnlyTools.Infrastructure.Data.Models.JobListing", b =>
                {
                    ...
                    b.Property<int?>("JobListingCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("JobListingCategoryId");
            ...
            modelBuilder.Entity("OnlyTools.Infrastructure.Data.Models.JobListing", b =>
                {
                    ...
                    b.HasOne("OnlyTools.Infrastructure.Data.Models.JobListingCategory", null)
                        .WithMany("Jobs")
                        .HasForeignKey("JobListingCategoryId");
